...
---------
 2.2.0
 - Replaced jPanelMenu with custom slide menu
 - Updated to Bootstrap 3.0.3
 - Updated to FontAwesome 4.0.3
 - Removed NiceScroll from HTML tag
 - Color styles simple generator (in LESS)
 - Fixed bug when empty body covered all content (on iPhone)
 - Changed Theme Options Panel
 - Updated examples code to follow latest Bootstrap 3 guidelines
 - Flat and Old style mode
 - Moved search bar to sidebar
 - Fixed some bugs with responsive views
 - Minor improvements
